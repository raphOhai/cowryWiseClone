      ...
      <div className="defaultPadding shiftButtom">
        <div className="stack">
          ...
          <div className="gridSection5">
            <div className="stackSection5 ">
              <div style={{ marginTop: "2rem" }} className="stack">
                <div className="flexBoxNoWrap">
                  ...
                  <p id="Section5BulletPointText" className="smallMainText2">
                    Top-Notch Security
                  </p>
                </div>
                <div className="widthRestrict2" style={{ marginLeft: "4rem" }}>
                  <p id="section5Text3" className="smallText">
            ...
            <div className="alignEnd flex">
              <div className="relative">
                <div className="blueBox overFlowHidden">
                  <img className="saveSvg" src="/security.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
