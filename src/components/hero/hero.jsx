...
const Hero = () => {
  return (
    ...
    <>
      <div className="stack">
        <div style={{maxWidth:"45rem"}} className="stack HideDesktop widthRestric">
          <p style={{maxWidth:"35rem"}} className="mainText widthRestric">Put your money to work.</p>

          <h6  style={{maxWidth:"35rem"}} className="smallMainText widthRestric">Invest wisely. Grow wealth.</h6>
